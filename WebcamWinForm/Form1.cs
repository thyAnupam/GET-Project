...
using WebCamWinForm.IRepository;
    ...
    public partial class Form1 : Form
    {
        ...
        private async Task OutputRecordingAsync()
        {
            ...
            try
            {
                ...
                if (outputVideo == null)
                {
                    lblStatus.Text = "Null recording. Please record again";
                ...
                else
                {
                    ...
                    lblStatus.Text = $"Recording saved to local disk with the file name {outputPath}. + Id = {result}";
